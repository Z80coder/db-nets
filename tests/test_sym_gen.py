...
def test_sym_gen():
    ...
    symbolic_mock_input = symbolic_primitives.to_boolean_symbolic_values(hard_mock_input)
    # Convert the literals to symbolic literals
    symbolic_jaxpr_literals = symbolic_primitives.to_boolean_symbolic_values(jaxpr.literals)
    ...
    # If this assertion succeeds then the non-standard symbolic evaluation of the jaxpr is is identical to the standard evaluation of the jaxpr
