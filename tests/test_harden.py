...
def test_harden():
    ...
    assert harden.harden([0.5, 0.6, 0.4, 0.0, 1.0]) == [False, True, False, False, True]
    assert jnp.array_equal(harden.harden(jnp.array([0.5, 0.6, 0.4, 0.0, 1.0])), [False, True, False, False, True])
    dict = {'a': 0.5, 'b': 0.6, 'c': 0.4, 'd': 0.0, 'e': 1.0}
    expected_dict = {'a': False, 'b': True, 'c': False, 'd': False, 'e': True}
...
def test_harden_compound_dict():
    dict = {'a': 0.5, 'b': 0.6, 'c': 0.4, 'd': 0.0, 'e': 1.0, 'f': {'a': 0.5, 'b': 0.6, 'c': 0.4, 'd': 0.0, 'e': 1.0}}
    expected_dict = {'a': False, 'b': True, 'c': False, 'd': False, 'e': True, 'f': {'a': False, 'b': True, 'c': False, 'd': False, 'e': True}}
    assert harden.harden(dict) == expected_dict
    dict = flax.core.frozen_dict.FrozenDict({'a': 0.5, 'b': 0.6, 'c': 0.4, 'd': 0.0, 'e': 1.0, 'f': {'a': 0.5, 'b': 0.6, 'c': 0.4, 'd': 0.0, 'e': 1.0}})
    expected_dict = {'a': False, 'b': True, 'c': False, 'd': False, 'e': True, 'f': {'a': False, 'b': True, 'c': False, 'd': False, 'e': True}}
    assert harden.harden(dict) == expected_dict

def test_harden_complex_compound_dict():
    dict = {'a': 0.5, 'b': 0.6, 'c': 0.4, 'd': 0.0, 'e': 1.0, 'f': {'a': 0.5, 'b': 0.6, 'c': 0.4, 'd': 0.0, 'e': 1.0, 'g': [0.5, 0.6, 0.4, 0.0, 1.0]}}
...
def test_harden_compound_list():
    ...
    expected_list = [False, True, False, False, True, [False, True, False, False, True]]
