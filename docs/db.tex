...
The main contributions of this work are (i) defining novel activation functions that harden to semantically equivalent boolean functions, (ii) defining novel network architectures that effectively learn boolean functions to solve multi-class classification problems, and (iii) experiments that demonstrate $\partial \mathbb{B}$ nets compete with existing approaches in terms of predictive performance yet yield considerably smaller models.
